...
Q_CONSTINIT static const qt_meta_stringdata_CLASSClientHandlerENDCLASS_t qt_meta_stringdata_CLASSClientHandlerENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(14, 12),  // "newDataReady"
        QT_MOC_LITERAL(27, 0),  // ""
...
void ClientHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->newDataReady((*reinterpret_cast< std::add_pointer_t<QByteArray>>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &ClientHandler::newDataReady; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ClientHandler::newDataReady(const QByteArray & _t1)
{
